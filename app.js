...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  //console.log('sumOfTwoNums: ' + sumOfTwoNums);
  var sumOfThreeNums = sum(sumOfTwoNums, c)[0];
  //console.log('sumOfThreeNums: ' + sumOfThreeNums);
  var productOfTwoNums = multiply(a, b)[0];
  var productOfThreeNums = multiply(productOfTwoNums, c)[0];
  var sumMessage = a + ' and ' + b + ' and ' + c + ' sum to ' + sumOfThreeNums + '.';
  var productMessage = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + productOfThreeNums + '.';
  return [sumOfThreeNums, productOfThreeNums, sumMessage, productMessage];
}
...
function sumArray(testArray){ //eslint-disable-line
  ...
  var arraySumMessage = testArray + ' was passed in as an array of numbers, and ' + arraySum + ' is their sum.';
...
function multiplyArray(testArray){ //eslint-disable-line
  ...
  var arrayProductMessage = 'The numbers ' + testArray + ' have a product of ' + arrayProduct + '.';
